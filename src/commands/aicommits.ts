...
import { generateOpenAICommitMessage } from "../utils/openai.js";
import { generateDeepSeekCommitMessage } from "../utils/deepseek.js";
	...
	(async () => {
		...
		try {
			if (config.API_PROVIDER === "openai") {
				...
				messages = await generateDeepSeekCommitMessage(
					config.DEEPSEEK_KEY,
